  ...
  return NextResponse.json({
    ...
    signals: {
      mayerMultiple: {
        ...
        unit: "ratio",
        descZh: "BTC 现价 / 200日均线，< 0.8 历史上对应主要积累区",
        descEn: "BTC price / 200d SMA — <0.8 historically major accumulation zone",
      },
      puellMultiple: {
        ...
        unit: "ratio",
        descZh: "日矿工收入 / 365日均值，< 0.5 矿工底部 (2022年12月信号 → +294%)",
        descEn: "Miner revenue / 365d avg — <0.5 miner bottom (Dec 2022 signal → +294%)",
      },
      fearGreed: {
        value: fgValue,
        zone: fgZ,
        ...
        unit: "index",
        descZh: "alternative.me 加密货币恐慌指数，< 20 历史对应高胜率买入窗口",
        descEn: "alternative.me Crypto Fear & Greed — <20 historically high-win-rate buy windows",
      },
    },
    upstream: {
