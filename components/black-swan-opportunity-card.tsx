...
function HoverContents({
  ...
  const modelLines =
    locale === "zh"
      ? [
          "黑天鹅机会指数（0–100）由 7 个因子加权合成，识别极端恐慌、强制爆仓和价值脱离区。",
          "",
          "① 插针出清 (25%)：日线下影线占比 + 60 期 z-score。",
          "② 极度恐慌 (20%)：alternative.me F&G + 7 期下行加速。",
          "③ 杠杆出清 (15%)：永续费率 + OI 24 期变动（强平 ≥ 8%）。",
          "④ 回撤幅度 (15%)：现价较 90 日高点的距离。",
          "⑤ 均值回归 (10%)：7 期收益 z-score + 20SMA 偏离。",
      ...
      : [
          "Black Swan Opportunity Index (0–100) — 7 factors composited to identify capitulation, forced flushes, and price-value disconnects.",
          "",
          "① Wick capitulation (25%): daily lower-wick ratio + 60-bar z-score.",
          "② Fear extreme (20%): F&G index + 7-print panic acceleration.",
          "③ Leverage flush (15%): funding + OI 24-print Δ (≥8% drop = flush).",
          "④ Drawdown (15%): close vs 90d high.",
          "⑤ Mean reversion (10%): 7-bar return z + 20-SMA gap.",
