...
export const MACRO_PRIORITY_CATEGORIES: readonly MacroPriorityCategory[] = [
  ...
  },
  {
    rank: 14,
    label: "14 市场资金流向",
    symbols: ["HYG", "LQD", "EMB", "ARKK", "KWEB", "EEM", "EM:HSGT_NORTH_TURNOVER", "EM:HSGT_SOUTH_NET_BUY", "EM:HSGT_SOUTH_CUMULATIVE", "EM:CN_MARGIN_BALANCE", "EM:CN_MARGIN_FIN_BALANCE", "EM:CN_MARGIN_BUY"],
...
const BASE_MACRO_INDICATORS: MacroIndicatorMeta[] = [
  ...
  },
  {
    ...
    providerSymbol: "EM:GOLD_CURRENCY:GOLD_RESERVES*100000000",
    source: "Eastmoney",
    name: "China Gold Reserves (黄金储备市值)",
    group: "Liquidity",
    unit: "usd",
    priority: 21.8,
    frequency: "Monthly (7th)",
    audience: ["宏观", "中国"],
    description: "央行黄金储备的美元市值。同时受持仓量与金价影响，因此上行不等于增持——要判断增持看持仓吨数（央行单独公布）。持续增持反映储备去美元化与对美债信用的对冲。",
  },
  {
  ...
  // --- 沪深港通 / 两融 (Eastmoney) ---
  {
    ...
    source: "Eastmoney",
    name: "Northbound Turnover (北向成交额，2024-08 停披)",
    group: "Equity",
    unit: "cny",
    priority: 39.1,
    frequency: "Daily",
...
export const SKIPPED_INDICATORS: readonly SkippedIndicator[] = [
  ...
  },
  {
    name: "北向资金持股市值",
    reason:
      "RPT_MUTUAL_DEAL_HISTORY 的 HOLD_MARKET_CAP 在北向汇总口径下实测全为 0；北向成交额（截至 2024-08 停披）保留为历史序列。",
