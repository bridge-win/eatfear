...
export const MACRO_PRIORITY_CATEGORIES: readonly MacroPriorityCategory[] = [
  ...
  },
  {
    ...
    symbols: [
      ...
      "EM:CN_NEW_LOANS",
      "EM:CN_NEW_LOANS_YTD",
      "EM:CN_TOTAL_DEPOSITS",
      "MOFCOM:TSF_TOTAL",
      "MOFCOM:TSF_RMB_LOANS",
      "MOFCOM:TSF_CORP_BONDS",
      "MOFCOM:TSF_EQUITY",
      "MOFCOM:TSF_TRUST_LOANS",
      "MOFCOM:TSF_UNDISCOUNTED_BA",
      "FRED:TOTLL",
      "FRED:WALCL",
      "FRED:TOTRESNS",
      "FRED:RRPONTSYD",
    ...
    sourceNote: "U.S. via FRED; China M0/M1/M2, new RMB loans via Eastmoney (PBoC release); 社融 (TSF) monthly flow and components via 商务部数据中心 mirror of the PBoC table (keyless POST).",
  },
  {
    rank: 6,
    label: "6 PMI",
  ...
  },
  {
    rank: 14,
    label: "14 市场资金流向",
    symbols: ["HYG", "LQD", "EMB", "ARKK", "KWEB", "EEM", "EM:HSGT_NORTH_TURNOVER", "EM:HSGT_NORTH_HOLDINGS", "EM:HSGT_SOUTH_NET_BUY", "EM:HSGT_SOUTH_CUMULATIVE", "EM:CN_MARGIN_BALANCE", "EM:CN_MARGIN_FIN_BALANCE", "EM:CN_MARGIN_BUY"],
    meaning: "Public proxies for money moving into equity and credit risk assets, plus the two hard A/H-share flow gauges: Stock Connect (北向/南向) and margin balance (两融).",
    impact: "Proxy strength supports short- to medium-term risk appetite; proxy weakness warns on de-risking.",
    sourceNote: "Yahoo ETF proxies; Stock Connect daily turnover/holdings/net buy and margin balances via Eastmoney (交易所披露). Northbound daily net buy stopped being disclosed in Aug 2024, so holdings value is the replacement gauge.",
  },
  {
    rank: 15,
    label: "15 成交额 / 换手率",
  ...
  },
  {
    ...
    symbols: [
      ...
      "EM:CN_FDI",
      "EM:CN_FDI_YTD_YOY",
      "SNAP:SAFE_NET_SETTLEMENT",
      "SNAP:SAFE_SETTLEMENT",
      "SNAP:SAFE_SALES",
      "SNAP:SAFE_SETTLEMENT_RATIO",
      "SNAP:SAFE_SALES_RATIO",
      "SNAP:SAFE_NET_RECEIPTS",
      "SNAP:SAFE_RECEIPTS",
      "SNAP:SAFE_PAYMENTS",
      "SNAP:SAFE_NET_SETTLEMENT_YTD",
      "SNAP:SAFE_NET_RECEIPTS_YTD",
    ],
    meaning:
    ...
    sourceNote:
      "BIS effective rates and IMF reserves via FRED (monthly, ~1-2 month lag); PBoC FX reserves, gold, FX deposits/loans and 中债 yields via Eastmoney datacenter; SAFE 银行结售汇 / 代客涉外收付款 (monthly, ~15th) from a hand-refreshed snapshot of the official releases — 2026 to date, extend by editing lib/data/china-manual-snapshot.json.",
  },
]
...
const BASE_MACRO_INDICATORS: MacroIndicatorMeta[] = [
  ...
  {
    symbol: "EM:CN_TOTAL_DEPOSITS",
    providerSymbol: "EM:FOREX_DEPOSIT:BASE_ACCUMULATE*100000000",
    source: "Eastmoney",
    name: "China Total Deposits (本外币存款余额)",
    group: "Liquidity",
    unit: "cny",
    priority: 21.9,
    frequency: "Monthly",
    audience: ["宏观", "中国"],
    description: "金融机构本外币各项存款余额（元）。M2 的主体部分；与住户存款并看可判断资金是在企业周转还是趴在居民定期里。",
  },
  {
    symbol: "EM:CN_FX_LOANS",
    providerSymbol: "EM:FOREX_LOAN:BASE_ACCUMULATE*100000000",
    source: "Eastmoney",
    ...
    frequency: "Monthly",
    audience: ["宏观", "中国", "FX"],
    description: "金融机构外汇贷款余额（美元）。企业借美元的意愿：升值预期下借美元套利增加，贬值预期下主动偿还美元债，是判断企业汇率预期的辅助口径。",
  },
  {
    symbol: "EM:CN_M2",
  ...
  },
  {
    ...
    providerSymbol: "EM:CUSTOMS:EXIT_BASE*1000",
    source: "Eastmoney",
  ...
  },
  {
    ...
    providerSymbol: "EM:CUSTOMS:IMPORT_BASE*1000",
    source: "Eastmoney",
  ...
  },
  {
    ...
    providerSymbol: "EM:CUSTOMS:EXIT_BASE-IMPORT_BASE*1000",
    source: "Eastmoney",
  ...
  },
  {
    ...
    providerSymbol: "EM:CUSTOMS:EXIT_ACCUMULATE-IMPORT_ACCUMULATE*1000",
    source: "Eastmoney",
  ...
  {
    symbol: "EM:CN_FDI",
    providerSymbol: "EM:FDI:ACTUAL_FOREIGN*1000",
    source: "Eastmoney",
  ...
  // --- 社融 (PBoC via 商务部数据中心) ---
  {
    ...
    providerSymbol: "MOFCOM:TSF_TOTAL",
    source: "MOFCOM",
    name: "China TSF Flow (社会融资规模增量)",
    group: "Credit",
    unit: "cny",
    priority: 21.05,
  ...
  },
  {
    ...
    providerSymbol: "MOFCOM:TSF_RMB_LOANS",
    source: "MOFCOM",
    name: "China TSF: RMB Loans to Real Economy (社融口径人民币贷款)",
    group: "Credit",
    unit: "cny",
    priority: 21.06,
    frequency: "Monthly (10th-15th)",
    audience: ["宏观", "中国"],
    description: "社融中对实体经济发放的人民币贷款当月增量（元），剔除了银行拆放非银的部分，比金融机构口径新增贷款更贴近实体融资。",
  },
  {
    symbol: "MOFCOM:TSF_CORP_BONDS",
    providerSymbol: "MOFCOM:TSF_CORP_BONDS",
    source: "MOFCOM",
    name: "China TSF: Corporate Bond Net Financing (企业债券净融资)",
    group: "Credit",
    unit: "cny",
    priority: 21.07,
    frequency: "Monthly (10th-15th)",
    audience: ["宏观", "中国"],
    description: "企业债券当月净融资（元）。直接融资占比上升的主渠道；为负说明到期偿还多于发行，信用收缩。",
  },
  {
    symbol: "MOFCOM:TSF_EQUITY",
    providerSymbol: "MOFCOM:TSF_EQUITY",
    source: "MOFCOM",
    name: "China TSF: Domestic Equity Financing (非金融企业境内股票融资)",
    group: "Credit",
    unit: "cny",
    priority: 21.08,
    frequency: "Monthly (10th-15th)",
    audience: ["宏观", "中国", "股票"],
    description: "非金融企业境内股票融资当月值（元）= IPO + 增发 + 配股实际募资。反映一级市场抽水强度与监管节奏。",
  },
  {
    symbol: "MOFCOM:TSF_TRUST_LOANS",
    providerSymbol: "MOFCOM:TSF_TRUST_LOANS",
    source: "MOFCOM",
    name: "China TSF: Trust Loans (信托贷款)",
    group: "Credit",
    unit: "cny",
    priority: 21.09,
    frequency: "Monthly (10th-15th)",
    audience: ["宏观", "中国"],
    description: "信托贷款当月增量（元）。影子银行/非标融资的代表项，2018 年资管新规后长期为负。",
  },
  {
    symbol: "MOFCOM:TSF_UNDISCOUNTED_BA",
    providerSymbol: "MOFCOM:TSF_UNDISCOUNTED_BA",
    source: "MOFCOM",
    name: "China TSF: Undiscounted Bank Acceptances (未贴现银行承兑汇票)",
    group: "Credit",
    unit: "cny",
    priority: 21.1,
    frequency: "Monthly (10th-15th)",
    audience: ["宏观", "中国"],
    description: "未贴现银行承兑汇票当月增量（元）。企业间贸易信用的温度计，与制造业景气高度相关。",
  },
  // --- SAFE 结售汇 / 涉外收付款 (manual snapshot; monthly release ~15th) ---
  {
    symbol: "SNAP:SAFE_NET_SETTLEMENT",
    providerSymbol: "CN:safe:net_settlement",
    source: "NBS/PBoC/BIS Snapshot",
    name: "China Bank FX Settlement Balance (银行结售汇差额)",
    group: "FX",
    unit: "usd",
    priority: 21.55,
    frequency: "Monthly (~15th)",
    audience: ["宏观", "中国", "人民币", "FX"],
    description: "银行结汇减售汇（美元）。为正=企业居民净卖出美元换人民币，升值压力；为负=净购汇，贬值压力。与贸易顺差的差距反映企业囤汇/结汇意愿。",
    transform: (value) => value * 100_000_000,
  },
  {
    symbol: "SNAP:SAFE_SETTLEMENT",
    providerSymbol: "CN:safe:settlement",
    source: "NBS/PBoC/BIS Snapshot",
    name: "China Bank FX Settlement (银行结汇)",
    group: "FX",
    unit: "usd",
    priority: 21.56,
    frequency: "Monthly (~15th)",
    audience: ["宏观", "中国", "人民币", "FX"],
    description: "银行为客户及自身办理的结汇总额（美元，毛额）。外汇卖给银行换人民币的流量口径，反映'有多少美元真正换成了人民币'。",
    transform: (value) => value * 100_000_000,
  },
  {
    symbol: "SNAP:SAFE_SALES",
    providerSymbol: "CN:safe:sales",
    source: "NBS/PBoC/BIS Snapshot",
    name: "China Bank FX Sales (银行售汇)",
    group: "FX",
    unit: "usd",
    priority: 21.57,
    frequency: "Monthly (~15th)",
    audience: ["宏观", "中国", "人民币", "FX"],
    description: "银行售汇总额（美元，毛额）。用人民币买美元的流量；持续走高对应购汇/出境/偿债需求增强。",
    transform: (value) => value * 100_000_000,
  },
  {
    symbol: "SNAP:SAFE_NET_RECEIPTS",
    providerSymbol: "CN:safe:net_receipts",
    source: "NBS/PBoC/BIS Snapshot",
    name: "China Cross-border Receipts minus Payments (涉外收付款差额)",
    group: "FX",
    unit: "usd",
    priority: 21.58,
    frequency: "Monthly (~15th)",
    audience: ["宏观", "中国", "人民币", "FX"],
    description: "银行代客涉外收入减对外付款（美元）。所有跨境资金进出的净额，含外汇与人民币、贸易与投资，比结售汇口径更宽。",
    transform: (value) => value * 100_000_000,
  },
  {
    symbol: "SNAP:SAFE_RECEIPTS",
    providerSymbol: "CN:safe:receipts",
    source: "NBS/PBoC/BIS Snapshot",
    name: "China Cross-border Receipts (涉外收入)",
    group: "FX",
    unit: "usd",
    priority: 21.59,
    frequency: "Monthly (~15th)",
    audience: ["宏观", "中国", "FX"],
    description: "银行代客涉外收入毛额（美元）。跨境资金流入的总规模，与海关出口总额并看可判断贸易繁荣度。",
    transform: (value) => value * 100_000_000,
  },
  {
    symbol: "SNAP:SAFE_PAYMENTS",
    providerSymbol: "CN:safe:payments",
    source: "NBS/PBoC/BIS Snapshot",
    name: "China Cross-border Payments (对外付款)",
    group: "FX",
    unit: "usd",
    priority: 21.6,
    frequency: "Monthly (~15th)",
    audience: ["宏观", "中国", "FX"],
    description: "银行代客对外付款毛额（美元）。",
    transform: (value) => value * 100_000_000,
  },
  {
    symbol: "SNAP:SAFE_SETTLEMENT_RATIO",
    providerSymbol: "CN:safe:settlement_ratio_proxy",
    source: "NBS/PBoC/BIS Snapshot",
    name: "China FX Settlement Ratio Proxy (结汇率代理)",
    group: "FX",
    unit: "percent",
    priority: 21.61,
    frequency: "Monthly (~15th)",
    audience: ["宏观", "中国", "人民币", "FX"],
    description: "结汇 ÷ 涉外收入（%）。外汇局口径的结汇率分母只含外汇收入，此处分母含人民币收付，绝对值偏低但趋势一致：上升=企业急着换人民币（看升），下降=囤美元（看贬）。",
  },
  {
    symbol: "SNAP:SAFE_SALES_RATIO",
    providerSymbol: "CN:safe:sales_ratio_proxy",
    source: "NBS/PBoC/BIS Snapshot",
    name: "China FX Purchase Ratio Proxy (购汇率代理)",
    group: "FX",
    unit: "percent",
    priority: 21.62,
    frequency: "Monthly (~15th)",
    audience: ["宏观", "中国", "人民币", "FX"],
    description: "售汇 ÷ 对外付款（%）。上升=购汇意愿增强（看贬）；与结汇率代理背离时信息量最大。",
  },
  {
    symbol: "SNAP:SAFE_NET_SETTLEMENT_YTD",
    providerSymbol: "CN:safe:net_settlement_ytd",
    source: "NBS/PBoC/BIS Snapshot",
    name: "China Bank FX Settlement Balance YTD (结售汇差额累计)",
    group: "FX",
    unit: "usd",
    priority: 21.63,
    frequency: "Monthly (~15th)",
    audience: ["宏观", "中国", "人民币", "FX"],
    description: "年初至今累计结售汇差额（美元）。与累计贸易顺差对照：差距越大，说明出口赚的美元越多留在企业手里没结汇。",
    transform: (value) => value * 100_000_000,
  },
  {
    symbol: "SNAP:SAFE_NET_RECEIPTS_YTD",
    providerSymbol: "CN:safe:net_receipts_ytd",
    source: "NBS/PBoC/BIS Snapshot",
    name: "China Cross-border Net Receipts YTD (涉外收付款差额累计)",
    group: "FX",
    unit: "usd",
    priority: 21.64,
    frequency: "Monthly (~15th)",
    audience: ["宏观", "中国", "FX"],
    description: "年初至今累计涉外收付款差额（美元）。",
    transform: (value) => value * 100_000_000,
  },
  ...
  // --- PBoC policy rates (manual snapshot; step series) ---
  {
    symbol: "SNAP:PBOC_OMO_7D",
    providerSymbol: "CN:rates:omo_7d",
    source: "NBS/PBoC/BIS Snapshot",
    name: "PBoC 7-day Reverse Repo Rate (7天逆回购操作利率)",
    group: "Rates",
    unit: "percent",
    priority: 8.85,
    frequency: "Event (step)",
    audience: ["宏观", "中国", "人民币"],
    description: "公开市场 7 天期逆回购操作利率——2024 年 7 月起的中国主要政策利率，LPR 在其基础上加点形成。利率走廊：临时隔夜逆回购 +50bp 为上限、正回购 −20bp 为下限。",
  },
  {
    symbol: "SNAP:PBOC_MLF_1Y",
    providerSymbol: "CN:rates:mlf_1y",
    source: "NBS/PBoC/BIS Snapshot",
    name: "PBoC 1Y MLF Rate (1年期MLF利率，2025-03 退出)",
    group: "Rates",
    unit: "percent",
    priority: 8.86,
    frequency: "Event (step, retired)",
    audience: ["宏观", "中国"],
    description: "1 年期中期借贷便利利率。2019-2024 年曾是 LPR 的定价锚；2025 年 3 月改为多重价位中标后不再有统一利率，政策利率功能退出，序列到此为止。",
  },
  // --- 沪深港通 / 两融 (Eastmoney) ---
  {
    symbol: "EM:HSGT_NORTH_TURNOVER",
    providerSymbol: "EM:MUTUAL_DEAL_NORTH:BUY_AMT+SELL_AMT*1000000",
    source: "Eastmoney",
    name: "Northbound Turnover (北向资金成交额)",
    group: "Equity",
    unit: "cny",
    priority: 39.1,
    frequency: "Daily",
    audience: ["股票", "中国", "资金流"],
    description: "沪股通+深股通当日买入与卖出成交额合计（元）。2024-08 起交易所不再披露北向当日净买入，成交额与持股市值是仅存的日频北向口径。",
  },
  {
    symbol: "EM:HSGT_NORTH_HOLDINGS",
    providerSymbol: "EM:MUTUAL_DEAL_NORTH:HOLD_MARKET_CAP",
    source: "Eastmoney",
    name: "Northbound Holdings Value (北向持股市值)",
    group: "Equity",
    unit: "cny",
    priority: 39.11,
    frequency: "Daily",
    audience: ["股票", "中国", "资金流"],
    description: "北向资金持有 A 股市值（元）。剔除涨跌后的变动近似外资净流入，是北向净买入停止披露后的替代观察口径。",
  },
  {
    symbol: "EM:HSGT_SOUTH_NET_BUY",
    providerSymbol: "EM:MUTUAL_DEAL_SOUTH:NET_DEAL_AMT*1000000",
    source: "Eastmoney",
    name: "Southbound Net Buy (南向资金当日净买入)",
    group: "Equity",
    unit: "cny",
    priority: 39.12,
    frequency: "Daily",
    audience: ["股票", "中国", "港股", "资金流"],
    description: "港股通（沪+深）当日成交净买额（元）。内地资金买港股的强度，2024 年后成为港股定价的主导力量之一。",
  },
  {
    symbol: "EM:HSGT_SOUTH_CUMULATIVE",
    providerSymbol: "EM:MUTUAL_DEAL_SOUTH:ACCUM_DEAL_AMT*1000000",
    source: "Eastmoney",
    name: "Southbound Cumulative Net Buy (南向历史累计净买入)",
    group: "Equity",
    unit: "cny",
    priority: 39.13,
    frequency: "Daily",
    audience: ["股票", "中国", "港股", "资金流"],
    description: "港股通开通以来累计净买入（元）。斜率即资金流速。",
  },
  {
    symbol: "EM:CN_MARGIN_BALANCE",
    providerSymbol: "EM:MARGIN_DAILY:FIN_BALANCE+LOAN_BALANCE*100000000",
    source: "Eastmoney",
    name: "A-share Margin Balance (两融余额)",
    group: "Equity",
    unit: "cny",
    priority: 39.2,
    frequency: "Daily",
    audience: ["股票", "中国", "杠杆"],
    description: "沪深两市融资余额 + 融券余额（元）。A 股杠杆资金总量，2015 年峰值 2.27 万亿；余额/流通市值比更能衡量杠杆热度。",
  },
  {
    symbol: "EM:CN_MARGIN_FIN_BALANCE",
    providerSymbol: "EM:MARGIN_DAILY:FIN_BALANCE*100000000",
    source: "Eastmoney",
    name: "A-share Financing Balance (融资余额)",
    group: "Equity",
    unit: "cny",
    priority: 39.21,
    frequency: "Daily",
    audience: ["股票", "中国", "杠杆"],
    description: "融资余额（元）。散户杠杆多头仓位，快速上升常对应行情加速阶段，见顶回落常领先指数 1-2 周。",
  },
  {
    symbol: "EM:CN_MARGIN_BUY",
    providerSymbol: "EM:MARGIN_DAILY:FIN_BUY_AMT*100000000",
    source: "Eastmoney",
    name: "A-share Daily Margin Buying (融资买入额)",
    group: "Equity",
    unit: "cny",
    priority: 39.22,
    frequency: "Daily",
    audience: ["股票", "中国", "杠杆"],
    description: "当日融资买入额（元）。融资买入占成交额比重是情绪温度计。",
  },
...
export const SKIPPED_INDICATORS: readonly SkippedIndicator[] = [
  {
    name: "SAFE 结售汇 / 涉外收付款 完整历史（2026-03 之前）",
    reason:
      "外管局每月以 HTML 表格 + Excel 发布，没有 JSON API。当前快照覆盖 2026-03 至最新月（含结汇率/购汇率代理）；更早历史需从外汇局数据栏目导入到 lib/data/china-manual-snapshot.json。",
  ...
  },
  {
    ...
    reason: "央行仅月末公告，无结构化接口。MLF 利率 2025-03 已退出政策利率，7 天逆回购利率已接入。",
    url: "http://www.pbc.gov.cn/zhengcehuobisi/125207/125213/125431/125469/index.html",
  },
  {
    name: "北向资金当日净买入",
    reason: "2024-08 起交易所停止披露，Eastmoney 字段为空；已改用北向成交额与持股市值，南向净买入不受影响。",
  ...
  { name: "ETF 资金流 / 共同基金资金流", reason: "需要 ICI 数据源；A 股北向/南向与两融已通过 Eastmoney 接入" },
]
