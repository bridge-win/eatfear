...
const DICT: Dict = {
  ...
  "smartPage.title": { zh: "聪明钱 · 跟单", en: "Smart Money & Copy Trading" },
  "smartPage.subtitle": {
    zh: "顶级交易员持仓、主动资金流、交易所跟单榜与链上聪明钱包。数据源：Binance 期货、OKX Rubik / Copy Trading、Hyperliquid，全部为交易所/链上公开数据。",
    en: "Top-trader positioning, aggressive flow, exchange copy-trading leaderboards and on-chain smart wallets. Sources: Binance futures, OKX Rubik / Copy Trading, Hyperliquid — all public exchange / on-chain data.",
  },
  ...
  "smartPage.verify.info": {
    zh: "上方的聪明钱信号有可能被人为制造来诱导散户接盘。本模块用几组独立、难以伪造的数据交叉验证:这些是真实承担风险的资金，还是诱导交易的假仓位。\n资金费率是持仓的真实成本、持仓量反映是否有新资金进场、跨所一致性说明信号不是单一交易所刷出来的、而链上持仓(下方 Hyperliquid)完全无法造假——这是终极验真锚点。",
    en: "The smart-money signals above could in principle be manufactured to bait retail into taking the other side. This module cross-checks them against independent, hard-to-fake data to tell real capital-at-risk from an inducement trap.\nFunding is a real holding cost, open interest shows whether fresh capital is entering, cross-venue agreement means the signal isn't fabricated on one exchange, and on-chain positions (Hyperliquid, below) cannot be faked at all — the ultimate authenticity anchor.",
  },
  ...
  "smartPage.verify.check.onchain.info": {
    zh: "下方 Hyperliquid 钱包持仓在链上结算,完全无法伪造——用它作为终极验真基准,对照交易所信号是否被真实资金印证。",
    en: "The Hyperliquid wallet positions below settle on-chain and cannot be faked — use them as the ground-truth benchmark against exchange signals.",
  },
  ...
  "smartPage.method.item1": {
    zh: "为什么是这些数据：顶级交易员持仓比按真实名义仓位加权、跟单榜按真实结算收益排名、链上持仓不可造假——三者都无法靠营销刷出来。",
    en: "Why these sources: top-trader ratios are weighted by real notional, copy leaderboards rank settled PnL, and on-chain positions cannot be faked — none can be gamed by marketing.",
  },
