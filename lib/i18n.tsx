...
const DICT: Dict = {
  ...
  "compare.info.solPrice": { zh: "优先级：A 级\n意义：SOL 是高 Beta 公链风险偏好的代理。\n与 BTC：日/周收益率联动中高，牛市扩散期相关性更强。\n影响方向：SOL 强势对应山寨风险偏好改善；SOL 急跌容易放大整体压力。\n实战：SOL 与 ETH 同步走强时，加密内部风险偏好通常更好。", en: "Priority: A-tier\nMeaning: SOL is a high-beta L1 risk proxy.\nVs BTC: moderate daily/weekly return linkage; stronger in bull diffusion phases.\nImpact: SOL strength signals better alt appetite; sharp SOL drops amplify stress.\nPractice: SOL + ETH rising together usually means healthier intra-crypto risk appetite." },
  ...
  "compare.info.dvol": { zh: "优先级：A 级\n意义：Deribit BTC 30 天隐含波动率指数，反映期权市场对未来的波动预期。\n与 BTC：与 BTC 波动率相关，不直接指示方向。\n影响方向：DVOL 上升=市场预期大波动（方向未定）；下降=风险溢价回落。\n实战：顶部风险=价格新高 + DVOL 抬升 + 成交量背离；适合判断「会不会大波动」。", en: "Priority: A-tier\nMeaning: Deribit BTC 30-day implied vol index—options market vol expectation.\nVs BTC: correlates with BTC volatility, not direction.\nImpact: rising DVOL = market expects big moves (direction unknown); falling = risk premium cooling.\nPractice: top risk = new high + rising DVOL + volume divergence; use for \"will it move big?\"" },
  ...
  "compare.info.russell": { zh: "优先级：B 级\n意义：罗素 2000 小盘股指数，反映风险扩散和融资敏感度。\n与 BTC：日收益率正相关，但通常弱于 Nasdaq/SP500。\n影响方向：Russell 强势=风险扩散至小盘；弱势=信用或增长压力。\n实战：辅助判断风险偏好是否「广泛扩散」，非首要宏观指标。", en: "Priority: B-tier\nMeaning: Russell 2000—small-cap and financing-sensitive risk diffusion.\nVs BTC: positive daily-return correlation, usually weaker than Nasdaq/SP500.\nImpact: Russell strength = broader risk-taking; weakness = credit/growth stress.\nPractice: supplementary gauge of risk diffusion—not the primary macro index." },
  "compare.info.gold": { zh: "优先级：B 级\n意义：黄金，反映实际利率、美元和避险需求。\n与 BTC：日收益率相关不稳定，有时同涨有时背离。\n影响方向：黄金上涨可能来自避险或实际利率下行，需结合 DXY 和 yields 解读。\n实战：辅助判断通胀/避险环境，非 BTC 核心驱动。", en: "Priority: B-tier\nMeaning: gold—real rates, USD and safe-haven demand.\nVs BTC: unstable daily-return correlation; sometimes aligned, sometimes divergent.\nImpact: gold up may mean hedging or lower real rates—read with DXY and yields.\nPractice: supplementary inflation/safe-haven context—not a core BTC driver." },
